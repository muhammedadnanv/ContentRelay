      ...
      <div className="bg-white sketch-card p-8 md:p-12 grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
        ...
        <div className="flex justify-center md:justify-end">
          <img 
            ...
            className="w-64 h-64 md:w-80 md:h-80 rounded-2xl object-cover sketch-card"
          />
        </div>
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-8">
            Muhammad Adnan is the founder of Content Relay, bringing years of expertise in automation 
            and content strategy to help professionals scale their LinkedIn presence effortlessly.
          </p>
        </div>
      </div>
    </section>
